...
public class DragTab extends JPanel {
    private final TabbedContentPane tab = new TabbedContentPane(true);
    private final JCheckBox gcheck  = new JCheckBox("Tab Ghost", true);
    private final JCheckBox tcheck  = new JCheckBox("Top", true);
    public DragTab() {
        super(new BorderLayout());
        TabbedContentPane sub = new TabbedContentPane(true);
        sub.setToolWindowManager(null);
        tab.setToolWindowManager(null);
        ...
        tab.addTab("Title 01", new JLabel("Test"));
        tab.addTab("Title 02", new JScrollPane(new JTree()));
        tab.addTab("Title 03", new JScrollPane(new JTextArea("asfasdfasfasdfas\nafasfasdfasd\nasfasd\nasfasdf\n")));
        tab.addTab("Title 04", new JLabel("<html>asfasfdasdfasdfsa<br>asfdd13412341234123446745fgh"));
        tab.addTab("Title 05", sub);
...
//            e.printStackTrace();
//        }
        final JFrame frame = new JFrame("DnDTabbedPane");
        frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        frame.getContentPane().add(new DragTab());
        frame.pack();
...
class DnDTabbedPane extends JTabbedPane {
    ...
    Image i = SwingUtil.loadImage("org/noos/xing/mydoggy/plaf/ui/icons/tabPointer.png");
...
//            g2.fill(lineRect);
            ...
            Point location = lineRect.getBounds().getLocation();
            g.drawImage(i, location.x, location.y, this);
        }
    }
}
