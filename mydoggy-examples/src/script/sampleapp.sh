...
CLASSPATH=../lib/mydoggy-api-1.3.2.jar
CLASSPATH=$CLASSPATH:../lib/mydoggy-plaf-1.3.2.jar
CLASSPATH=$CLASSPATH:../lib/mydoggy-res-1.3.2.jar
CLASSPATH=$CLASSPATH:../lib/mydoggy-examples-1.3.2.jar
