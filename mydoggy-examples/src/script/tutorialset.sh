...
CLASSPATH=../lib/mydoggy-api-1.4.0.jar
CLASSPATH=$CLASSPATH:../lib/mydoggy-plaf-1.4.0.jar
CLASSPATH=$CLASSPATH:../lib/mydoggy-res-1.4.0.jar
CLASSPATH=$CLASSPATH:../lib/mydoggy-examples-1.4.0.jar
