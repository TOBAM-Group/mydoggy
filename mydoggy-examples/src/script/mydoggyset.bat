...
SET CLASS_PATH=%MYDOGGY_HOME%\lib\mydoggy-api-1.4.0.jar
SET CLASS_PATH=%CLASS_PATH%;%MYDOGGY_HOME%\lib\mydoggy-plaf-1.4.0.jar
SET CLASS_PATH=%CLASS_PATH%;%MYDOGGY_HOME%\lib\mydoggy-res-1.4.0.jar
SET CLASS_PATH=%CLASS_PATH%;%MYDOGGY_HOME%\lib\mydoggy-itest-1.4.0.jar
SET CLASS_PATH=%CLASS_PATH%;%MYDOGGY_HOME%\lib\mydoggy-examples-1.4.0.jar
